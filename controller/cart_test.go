...
func getCartItem(t *testing.T, details *ServerDB, quantity int64, productID, userID string, trigger ...string) (*entity.CartItem, error) {
	...
	if len(trigger) > 0 {
		...
		require.Equal(t, productID, cart.ProductID)
...
func addProductToCart(t *testing.T, details *ServerDB, user entity.UserResponse, productID string, quantity int64, trigger ...string) {
